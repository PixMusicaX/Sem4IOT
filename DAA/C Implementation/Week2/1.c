...
int main()
{
    ...
    //Please note it is perfectly fine for the average case to be better than the best case, quick sort is designed for achieving better performance with random data
    for (i = 0; i < n; i++)
        arr[i] = rand() % (n * 1000);
    start = clock();
    quick_sort(arr, 0, n - 1);
